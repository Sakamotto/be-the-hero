...
export default function Detail() {
    ...
    const message = `Olá ${incident.name}, estou entrando em contato, pois gostaria de ajudar no caso "${incident.title}" com o valor de R$ ${Intl.NumberFormat('pt-BR', { currency: 'BRL', style: 'currency' }).format(incident.value)}`;
